...
class DocumentContentTool(BaseTool):
    ...
    description = (
        ...
        "upsert_section inherits the confirmed outline title when title is omitted, and should carry "
        "source_ids and fact_status in the same call (backfilling provenance later costs a call per section). "
        "It returns a compact summary, not the full body; use get_section only when body text is needed. "
