...
def test_three_chinese_business_skills_are_shipped_by_default():
    skill_dirs = [
        path.name
    ...
    assert skill_dirs == ["code-review", "eval-writer", "ycore-analytics"]
...
def test_readme_positions_ycore_as_generic_skill_runtime():
    ...
    assert "默认发布三个示例业务 Skill" in readme
